========================================================================
    KONSOLENANWENDUNG: TUILibSteeringWheel-Projektübersicht
========================================================================

Diese TUILibSteeringWheel-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die TUILibSteeringWheel-Anwendung besteht.


TUILibSteeringWheel.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen TUILibSteeringWheel.pch sowie eine vorkompilierte 
