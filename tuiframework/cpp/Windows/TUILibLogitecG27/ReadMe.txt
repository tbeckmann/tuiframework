========================================================================
    KONSOLENANWENDUNG: TUILibLogitecG27-Projektübersicht
========================================================================

Diese TUILibLogitecG27-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die TUILibLogitecG27-Anwendung besteht.


TUILibLogitecG27.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen TUILibLogitecG27.pch sowie eine vorkompilierte 
