========================================================================
    KONSOLENANWENDUNG: TUIBinFunctionalDrvServer3-Projektübersicht
========================================================================

Diese TUIBinFunctionalDrvServer3-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die TUIBinFunctionalDrvServer3-Anwendung besteht.


TUIBinFunctionalDrvServer3.vcproj
...
TUIBinFunctionalDrvServer3.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen TUIBinFunctionalDrvServer3.pch sowie eine vorkompilierte 
