========================================================================
    KONSOLENANWENDUNG: TUIBinFunctionalClient3-Projektübersicht
========================================================================

Diese TUIBinFunctionalClient3-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die TUIBinFunctionalClient3-Anwendung besteht.


TUIBinFunctionalClient3.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen TUIBinFunctionalClient3.pch sowie eine vorkompilierte 
