========================================================================
    STATISCHE BIBLIOTHEK: TUILibPedalAndShift-Projektübersicht
========================================================================

Dieses TUILibPedalAndShift-Bibliotheksprojekt wurde vom 
Anwendungs-Assistenten für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die TUILibPedalAndShift-Anwendung besteht.


TUILibPedalAndShift.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen TUILibPedalAndShift.pch sowie eine vorkompilierte 
